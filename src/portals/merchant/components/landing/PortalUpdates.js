...
const PortalUpdates = ({ data }) => {
  return (
    <Card>
      <Card.Header as={Flex} alignItems="center">
        <img src={signalImg} alt="!" height={35} className="me-2" />
        <h5 className="fw-normal text-800 mb-0">Choice Portal Updates</h5>
      </Card.Header>
