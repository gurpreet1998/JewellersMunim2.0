    ...
    <>
      <Row className="g-3 mb-3">
        <Col>
          <Card>
            <Card.Header>
              <h5 className="fw-normal text-800 mb-0">DisputeAndComplaints</h5>
            </Card.Header>
            <Card.Body className="overflow-hidden p-lg-6">
              <Row className="align-items-center justify-content-between">
                ...
                <Col lg={6} className="ps-lg-4 my-5 text-center text-lg-start">
                  ...
                  <p className="lead">DisputeAndComplaints Page.</p>
                </Col>
              </Row>
            </Card.Body>
          </Card>
...
export default DisputeAndComplaints;
