export const loanStatusTodaysStatements = {
  columns: [
    {
      accessor: 'loanId',
      Header: 'Loan ID'
    ...
    {
      accessor: 'loanApplicationId',
      Header: 'Loan Applicatio ID'
    },
    {
      accessor: 'location',
      Header: 'Location'
...
export const dailyCCPaymentExceptions = {
  ...
  data: [
    ...
    {
      id: 6,
      applicationId: '1224466',
      consumer: 'Afblaefaee Franklin',
      serviceAmount: '$17,500.00',
      appDate: '10/05/2021',
      appStatus: 'CP+ Offers',
      salesAgent: 'Mitch Smith',
...
export const accountingStatsData = [
  {
    id: 1,
    title: 'Unfunded CC',
    amount: 1540,
  ...
  {
    id: 4,
    title: "Today's Principle Settlements",
    amount: 1120,
    target: '1423 vs 256',
    icon: 'share',
    caret: 'caret-down',
  ...
  {
    id: 5,
    title: "Today's Interest Settlements",
    amount: 1120,
    target: '1423 vs 256',
    icon: 'list',
    caret: 'caret-down',
